...
print("r1 is {}x{} and its are is {} and perimeter is {}".
      format(r1.length,r1.breadth,r1.area(),r1.perimeter()))

print("is r1 a square? {}".format(r1.isSquare()))

print("{} has {} as factors and is a {}".
      format(n1,numOps.factorsOf(n1),("Prime" if numOps.isPrime(n1) else "Composite")))
